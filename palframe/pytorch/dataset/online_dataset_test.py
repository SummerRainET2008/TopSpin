...
import pickle
import numpy
from palframe.pytorch.dataset.online_dataset import get_batch_data
...
def main():
  ...
  batch_iter = get_batch_data(
    "/tmp/feat", 1, batch_size, worker_num,
    False, 0, 1,  pad_batch_data_func, None
  )
