...
class AttentionLayer(Layer):
  ...
  def call(self, inputs, mask=None, training=None, **kwargs):
    ...
    batch_size, from_seq_len, from_width = input_shape[0], input_shape[
        1], input_shape[2]
    ...
    def transpose_for_scores(input_tensor, seq_len):
      output_shape = [
          batch_size, seq_len, self.params.num_heads, self.params.size_per_head
      ]
    ...
    value = tf.reshape(value, [
        batch_size, to_seq_len, self.params.num_heads,
