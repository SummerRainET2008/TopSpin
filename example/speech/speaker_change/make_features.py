...
if __name__ == '__main__':
  ...
  process_xvector_data(
    'example/speech/speaker_change/data/train.scp',
    'example/speech/speaker_change/feat/train.pkl',
    6
  )
  process_xvector_data(
    'example/speech/speaker_change/data/vali.scp',
    'example/speech/speaker_change/feat/vali.pkl',
    6
  )
  process_xvector_data(
    'example/speech/speaker_change/data/test.scp',
    'example/speech/speaker_change/feat/test.pkl',
    6
  )